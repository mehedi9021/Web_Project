...
<!--FORM-->
<marquee scrolldelay="50">Warning: You have to fill up all the sections. Otherwise signUp won't be completed!!</marquee>
...
$q = "insert into signup_info(fname, lname, phone, address, age, email, username, religion, password) Value('$fname', '$lname', '$phone', '$address', '$age', '$email', '$username', '$religion', '$password')";
$run = mysqli_query($con,$q);

if($run){
echo 'sign up successfully done. Enjoy the special offers and features of E-Food corner!! ';
}
else{
echo'not working!!';
}
